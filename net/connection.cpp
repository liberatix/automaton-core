...
connection::connection(connection::connection_handler* _handler):handler(_handler) {};//, sequence_id(0) {};

connection* connection::create(const std::string& type, const std::string& address,
...
std::map<std::string, connection::factory_function> connection::connection_factory;
