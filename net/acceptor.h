...
public:
	/** 
		Handler class used to inform the client for events.
			- on_requested should be invoked when a peer want to connect; it passes the 
				address of the remote peer.
			- on_connected should be invoked if the connection was accepted by the peer and 
				connection was made; it passes the resulting connection or null if no
				connection was made;
  ...
  virtual void accept() = 0;
	...
	**/
	...
	/**
		...
		See "typedef acceptor* (*factory_function)..." above to check what arguments 
