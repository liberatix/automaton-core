...
TEST(protobuf_schema, find_enum) {
  ...
  **/
  ...
  custom_schema.add_enum_field(schema::field_info(2,
      schema::field_type::enum_type, "inner_enum_field", "A.inner_enum",
          false), m1);
  custom_schema.add_enum_field(schema::field_info(3,
      schema::field_type::enum_type, "outer_enum_field", "outer_enum",
      false), m1);
  custom_schema.add_enum_field(schema::field_info(1,
        schema::field_type::enum_type, "enum_field1", "A.inner_enum",
        false), m2);
  custom_schema.add_enum_field(schema::field_info(2,
      schema::field_type::enum_type, "enum_field2", "outer_enum",
      true), m2);
