...
TEST(data_protobuf, messages) {
  ...
  custom_schema.add_scalar_field(
      schema::field_info(1, schema::string, "string_field", "", false),
      m1);
  custom_schema.add_message_field(
      schema::field_info(2, schema::message_type, "message_field",
          "pack1.TestMsg", false),
      m1);
  custom_schema.add_message_field(
      schema::field_info(3, schema::message_type, "message_field2",
          "TestMsg2", false),
      m1);
  ...
  custom_schema2.add_scalar_field(
  ...
  custom_schema3.add_scalar_field(
      schema::field_info(1, schema::string, "string_field", "", false), m1);
