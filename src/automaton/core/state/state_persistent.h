#ifndef AUTOMATON_CORE_STATE_PERSISTENT_H__
#define AUTOMATON_CORE_STATE_PERSISTENT_H__
...
class state_persistent : public state{
 public:
  explicit state_persistent(crypto::hash_transformation* hasher);
...
#endif  //  AUTOMATON_CORE_STATE_PERSISTENT_H__
