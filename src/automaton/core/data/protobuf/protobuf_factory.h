...
class protobuf_factory: public factory {
 private:
  ...
  std::stack<unsigned int> free_message_spots;

  /// Message type name to index in vector<const Message*> schemas
  std::map<std::string, unsigned int> schemas_names;
  ...
  std::map<std::string, unsigned int> enums_names;
  ...
  **/
  ...
  const google::protobuf::Message* get_schema(unsigned int schema_id);
  ...
  */
  void dump_enum(unsigned int enum_id, std::ostream& ostream_) const;

  /*
    Returns the number of enums in the whole schema definition (both top-level and nested).
  */
  unsigned int get_enums_number() const;
  ...
  */
  unsigned int get_enum_id(const std::string& enum_name) const;
  ...
  */
  int get_enum_value(unsigned int enum_id, const std::string& value_name) const;
  ...
  */
  schema::field_info get_field_info(unsigned int schema_id, unsigned int index) const;
  ...
  /*
    ...
    exception will be thrown.
  */
  std::unique_ptr<msg> new_message_by_id(unsigned int schema_id);
  ...
  */
  unsigned int create_copy_message(int message_id);
  ...
  */
  unsigned int get_schema_id(const std::string& schema_name) const;
  ...
  */
  std::string get_schema_name(unsigned int schema_id) const;

  /*
    Returns the schema id of the message with the given id. If such message
    doesn't exist, exception will be thrown.
  */
  unsigned int get_message_schema_id(int message_id) const;
  ...
  */
  std::string get_field_type(unsigned int schema_id, unsigned int tag) const;
  ...
  /*
    ...
    exception will be thrown.
  */
  std::string get_message_field_type(unsigned int schema_id, unsigned int tag) const;
  ...
  */
  std::string get_enum_field_type(unsigned int schema_id, unsigned int tag) const;
  ...
  */
  unsigned int get_field_tag(unsigned int schema_id, const std::string& name) const;
  ...
  /*
    ...
    be thrown.
  */
  bool is_repeated(unsigned int schema_id, unsigned int tag) const;
};
